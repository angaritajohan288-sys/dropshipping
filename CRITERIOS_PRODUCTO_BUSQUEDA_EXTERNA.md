# Criterios para buscar producto fuera de DSers

DSers quedará como herramienta de importación y sincronización con Shopify. La búsqueda inicial se realizará en catálogos y marketplaces externos porque el buscador interno devolvió resultados poco precisos para consultas de accesorios gamer.
...
| Entrega internacional | Se acepta una ventana de dos a tres semanas solo si se indica con claridad antes del pago y el pedido tiene tracking. |
