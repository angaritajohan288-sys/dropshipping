...
6. En **Radar de fechas**, avanzar y retroceder un mes, seleccionar un día con vencimientos y abrir una tarea de la lista lateral. Confirmar que se navega a la fase correcta y se abre el espacio privado de esa tarea.
7. Usar el selector de **Modo claro** o **Modo oscuro** desde la barra lateral (o el encabezado móvil), recargar la sesión y comprobar que la preferencia persiste. Revisar que títulos, texto auxiliar, tarjetas y alertas mantienen contraste legible en ambos temas.
8. Recorrer plantilla, exportación, filtros, anticipación, ordenamiento, calendario y selector de tema con la tecla `Tab` para comprobar el foco visible y el uso sin ratón, en escritorio y móvil.
