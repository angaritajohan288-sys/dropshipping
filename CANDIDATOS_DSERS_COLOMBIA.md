# Candidatos localizados en DSers para Colombia

**Estado:** investigación inicial. Ningún producto de esta tabla se ha importado, publicado ni comprado.

## Candidato 1: set de reposamuñecas para teclado y mouse

En el catálogo de DSers, con el destino configurado en Colombia y orden por pedidos, apareció un producto titulado **“Keyboard Mouse Wrist Rest Angel Wing Memory Foam Mouse Pad Set”**. El registro visible mostró un rango de precio de **US$5,90–13,33**, flete de **US$1,99**, **3.000 pedidos** y calificación de **4,9**.

| Filtro | Evaluación preliminar |
|---|---|
| Sin batería, USB o electrónica | Pasa: es un set de espuma/reposamuñecas. |
| Sin marca o personaje reconocido en el título | Pasa de forma preliminar; “Angel Wing” describe el diseño, pero se debe revisar la ficha e imágenes finales. |
| Demanda y calificación | Pasa la señal inicial: 3.000 pedidos y 4,9. |
| Logística | Pendiente: confirmar tamaño, peso, variante concreta y fecha de entrega a Colombia. |
| Margen y competencia local | Pendiente: contrastar el set exacto en Mercado Libre Colombia antes de cotizar o importar. |
| Copy comercial seguro | Debe presentarse como accesorio de comodidad/organización de escritorio, sin promesas médicas o de tratamiento. |

> **Siguiente comprobación:** obtener la ficha exacta desde DSers y compararla contra al menos tres ofertas colombianas de sets equivalentes. Solo si conserva margen y no existe una alternativa local claramente más barata se solicitará una muestra.

## Resultado de la exploración de DSers

Con Colombia seleccionado como destino, se probaron las búsquedas “gaming mouse bungee”, “mouse pad” y “wrist rest”, con resultados ordenados por pedidos. La primera no produjo un candidato: los modelos físicos de soporte de cable tenían calificaciones inferiores a 4,7, ventas limitadas o incluían USB/carga. La segunda confirmó que tapetes y organizadores genéricos están muy mezclados con artículos no relacionados. La tercera produjo el set de reposamuñecas como la primera señal consistente.

**Registro de filtros aplicado:** fuente AliExpress dentro de DSers; destino **Colombia**; origen **All**; orden **Orders**; exclusión manual de baterías, Bluetooth, USB, carga, productos de marca y calificaciones inferiores a 4,7. Esta configuración se mantendrá para cualquier búsqueda posterior.

| Consulta de DSers | Hallazgo | Decisión |
|---|---|---|
| `gaming mouse bungee` | Los soportes físicos sin USB visibles tuvieron pocas ventas o calificación inferior al umbral; los primeros resultados eran mouse, cargadores o Bluetooth. | Descartar. |
| `mouse pad` | Hubo tapetes físicos con 4.6–4.7 y miles de pedidos, pero son artículos muy genéricos y con gran superficie de envío. | No priorizar. |
| `wrist rest` | El set de teclado + mouse mostró 3.000 pedidos, 4,9 y coste de producto visible desde US$5,90, más US$1,99 de envío. | Validar variante exacta y competencia. |

Una búsqueda pública de ofertas colombianas muestra sets comparables de espuma viscoelástica alrededor de COP 48.900, por lo que el producto no está libre de competencia. El siguiente paso no es importarlo: se requiere abrir la ficha exacta, fijar variante y coste real en Colombia, y calcular si existe margen después de la publicidad.

> **Verificación de cierre:** el documento contiene una ruta descartada (`gaming mouse bungee`), una ruta no priorizada (`mouse pad`) y un candidato preliminar (`wrist rest`), junto con sus señales de pedidos, precio, flete y calificación visibles en DSers.

## Contraste de mercado colombiano

El producto compite con sets locales ya establecidos. En Mercado Libre Colombia, la búsqueda de reposamuñecas para teclado muestra un set de teclado y mouse con espuma viscoelástica a COP 48.900; la página de resultados también muestra distintas variantes de reposamuñecas.[1] Una oferta de Éxito para un set comparable de memory foam se muestra a COP 60.990, con despacho de 3 a 6 días hábiles.[2]

| Comparación | Candidato DSers | Alternativas locales visibles | Implicación |
|---|---|---|---|
| Señal de demanda | 3.000 pedidos y 4,9 | Oferta visible en Mercado Libre y Éxito.[1] [2] | La necesidad existe, pero no es exclusiva. |
| Coste de entrada | US$5,90–13,33 + US$1,99 de flete, según variante. | COP 48.900–60.990 en las referencias locales.[1] [2] | Hay que elegir la variante exacta antes de calcular margen; el rango de coste es demasiado amplio. |
| Entrega | Aún pendiente de abrir la ficha exacta y confirmar la fecha a Colombia. | 3–6 días hábiles en la oferta de Éxito.[2] | La entrega internacional debe justificarse con diseño, precio o kit diferenciado. |
